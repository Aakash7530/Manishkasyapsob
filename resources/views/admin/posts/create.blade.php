    ...
    <div class="px-4 py-6 sm:p-8">
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="col-span-full">
                ...
                <div class="mt-2">
                    <textarea id="excerpt" name="excerpt" rows="6" required
                              class="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-primary-600 sm:text-sm">{{ old('excerpt') }}</textarea>
                </div>
            ...
            <div class="sm:col-span-3 border border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                <label class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Upload Image</label>
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <input type="text" name="tags" id="tags" placeholder="politics, bihar, news" value="{{ old('tags') }}"
                           class="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-primary-600 sm:text-sm">
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="2"
                                  class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-primary-600 sm:text-sm">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
            </div>
